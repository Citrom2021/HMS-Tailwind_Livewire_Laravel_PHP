...
<!-- Styles -->
  ...
  <div class="container-fluid">
    ...
    <a href="#" class="navbar-brand nav-link"><i class="fa fa-users"></i><span style="margin-left:5px;">Yurta Inc</span></a>
    ...
    <div class="collapse navbar-collapse top_nav" id="navbarSupportedContent">
      <ul class="navbar-nav mx-auto ">
        ...
        <li class="navbar-brand"><a href="#" class="nav-link ">Reserve a Yurta</a>
        </li>
            ...
            <!-- @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        @endif
                    @endauth
                    <a href="http://localhost/hms22/hms/" target="_blank" class="ml-4 text-sm text-gray-700 underline">Back to Site</a>
                </div>
            @endif -->

...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/style.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/animate.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/aos.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/bootstrap-datepicker.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/bootstrap-theme.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/bootstrap.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/bootstrap.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/flaticon.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/icomoon.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/ionicons.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/jquery.dataTables.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/jquery.timepicker.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/magnific-popup.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/open-iconic-bootstrap.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/owl.carousel.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('assets/hms2css/stylesheets/owl.theme.default.min.css')}}">
	<title></title>
</head>
...
<!--Gallery section section-->
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  	<script src="{{URL::asset('assets/hms2js/javascripts/aos.js')}}" type="text/javascript">	</script>
	<script src="{{URL::asset('assets/hms2js/javascripts/bootstrap-datepicker.js')}}" type="text/javascript">	</script>
	<script src="{{URL::asset('assets/hms2js/javascripts/bootstrap.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/bootstrap.min.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/button.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/dataTables.bootstrap.js')}}" type="text/javascript">	</script>
	<script src="{{URL::asset('assets/hms2js/javascripts/google-map.js')}}" type="text/javascript">	</script>
	<script src="{{URL::asset('assets/hms2js/javascripts/jquery-3.2.1.min.js')}}" type="text/javascript">	</script>
	<script src="{{URL::asset('assets/hms2js/javascripts/jquery-migrate-3.0.1.min.js')}}" type="text/javascript">	</script>
	<script src="{{URL::asset('assets/hms2js/javascripts/jquery.animateNumber.min.js')}}" type="text/javascript">	</script>
	<script src="{{URL::asset('assets/hms2js/javascripts/jquery.dataTables.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/jquery.easing.1.3.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/jquery.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/jquery.magnific-popup.min.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/jquery.min.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/jquery.stellar.min.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/jquery.waypoints.min.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/main.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/owl.carousel.min.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/popper.min.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/range.js')}}" type="text/javascript"></script>
	<script src="{{URL::asset('assets/hms2js/javascripts/scrollax.min.js')}}" type="text/javascript"></script>
    </body>
	</html>
